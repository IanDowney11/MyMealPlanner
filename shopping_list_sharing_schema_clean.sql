-- Shopping List Sharing Schema (Clean Version)
...
-- Clean up any existing problematic triggers first
...
-- Success message
SELECT 'Shopping List Sharing Schema installed successfully!' as result;